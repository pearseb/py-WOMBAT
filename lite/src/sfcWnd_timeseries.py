...
def get_sfcWnd_timeseries(yyyy, latitude, longitude, dt):
    ...
    # Load dataset
    fname = '/g/data/qv56/replicas/input4MIPs/CMIP6/OMIP/MRI/MRI-JRA55-do-1-5-0/atmos/3hrPt/uas/gr/v20200916/uas_input4MIPs_atmosphericState_OMIP_MRI-JRA55-do-1-5-0_gr_%i01010000-%i12312100.nc'%(yyyy,yyyy)
    data = xr.open_dataset(fname)
    uas = data['uas']
    fname = '/g/data/qv56/replicas/input4MIPs/CMIP6/OMIP/MRI/MRI-JRA55-do-1-5-0/atmos/3hrPt/vas/gr/v20200916/vas_input4MIPs_atmosphericState_OMIP_MRI-JRA55-do-1-5-0_gr_%i01010000-%i12312100.nc'%(yyyy,yyyy)
    data = xr.open_dataset(fname)
    vas = data['vas']
    data.close()
